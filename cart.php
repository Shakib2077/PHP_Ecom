  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./users_area/user_registration.php">Registert</a>
        </li>
        <li class="nav-item">
...
if($result_count>0){
    ...
    <input type='submit' value='Continue Shooping' class='bg-info px-3 py-2 border-0 mx-3' name='continue_shooping'>
    ...
    echo"<a href='input.php'><button class='bg-info px-3 py-2 border-0 mx-3'>Continue Shopping</button></a>";
}
