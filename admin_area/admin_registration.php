 ...
 <div class="row d-flex justify-content-center">
    ...
    <div class="col-lg-6 col-xl-4">
       ...
       <div class="form-outline mb-4">
        ...
        <div>
            <input type="Submit" class="bg-info py-3 px-3 border-0" name="admin_registration" value="Registration">
             <p class="small fw-bold mt-3 pt-1">Don't you have an account? <a href="admin_login.php" class="link-danger">Login</a></p>
        </div>
    </form>
    </div>
 </div>
